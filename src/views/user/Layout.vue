<template>
  <div class="user-center-container">
    <el-row :gutter="20">
      <!-- 左侧用户信息和导航 -->
      <el-col :lg="4" :md="5" :sm="6" :xs="24">
        <el-card class="user-info-card">
          <div class="user-profile">
            <el-avatar v-if="userInfo.avatar" :size="80" :src="avatarUrl">
              <el-icon>
                <User/>
              </el-icon>
            </el-avatar>
...
import {ChatDotRound, Goods, List, Location, Lock, Star, User, UserFilled} from '@element-plus/icons-vue'
